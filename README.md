# 💫 About Me:
I am a T.Y. B.B.A (CA) student at Abeda Inamdar Senior College (Affiliated to Savitribai Phule Pune University) and a forward-thinking Full Stack Developer. Unlike traditional developers, I view Artificial Intelligence not just as a tool, but as an architectural partner. My methodology—Context-First Engineering—allows me to build sophisticated, production-ready web and mobile systems at a pace that matches the speed of modern business.<br><br>My expertise is hybrid: I bridge the gap between Silicon Logic (Kotlin, PHP, Python) and Market Strategy (Google/Meta Ads). Whether I am engineering a self-updating Android calculator, designing a serverless e-commerce platform for a restaurant, or optimizing a digital ad campaign, my goal is always the same: to create efficient, scalable solutions that solve real-world problems. I am currently open to opportunities where I can leverage my technical depth and creative vision.

## 🌐 Socials:
[![Instagram](https://img.shields.io/badge/Instagram-%23E4405F.svg?logo=Instagram&logoColor=white)](https://instagram.com/just.the.guy.ak) [![LinkedIn](https://img.shields.io/badge/LinkedIn-%230077B5.svg?logo=linkedin&logoColor=white)](https://linkedin.com/in/altamaskkhan) [![X](https://img.shields.io/badge/X-black.svg?logo=X&logoColor=white)](https://x.com/justtheguyak) [![email](https://img.shields.io/badge/Email-D14836?logo=gmail&logoColor=white)](mailto:theguyakbusinessmail@gmail.com) 
